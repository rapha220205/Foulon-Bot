...
module.exports = {
  ...
  async execute(message, args) {
    ...
    if (!channel) return message.reply("Vous devez etre dans un salon vocal").catch(console.error);
    ...
    if (serverQueue) {
      ...
      return serverQueue.textChannel
        .send(`✅ **${song.title}** à etait ajouter a la file d'attente par ${message.author}`)
        .catch(console.error);
    }
